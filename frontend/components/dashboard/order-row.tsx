...
export function OrderRow({
  ...
  const statusConfig = {
    ...
    in_transit: { color: 'bg-orange-500/20 text-orange-300 border border-orange-500/30 pulse-glow', label: 'In Transit', icon: '🚚' },
  ...
  return (
    <div className={`glass rounded-xl p-4 mb-3 border-l-4 ${borderColorClasses[status]} hover:bg-white/20 transition-all duration-300 group`}>
